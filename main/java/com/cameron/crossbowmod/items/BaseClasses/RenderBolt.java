...
public class RenderBolt<T extends EntityBolt> extends Render<T>{
	...
	private ResourceLocation boltTextures;
	
	 public RenderBolt(RenderManager renderManagerIn, Bolts bolt)
	    {
	        super(renderManagerIn);
	        boltTextures = new ResourceLocation("crossbowmod:textures/entity/"+bolt.boltTexture+".png");
	    }
