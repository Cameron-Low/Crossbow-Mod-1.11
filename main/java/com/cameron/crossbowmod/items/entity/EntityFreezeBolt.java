...
public class EntityFreezeBolt extends EntityBolt{

	public EntityFreezeBolt(World worldIn) {
		super(worldIn);
		this.bolt = Bolts.FREEZE;
	}
	...
	public EntityFreezeBolt(World worldIn, EntityLivingBase shooter, Bolts bolt){
